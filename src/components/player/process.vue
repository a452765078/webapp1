<template>
    <div class="process">
        <div class="curProcessTime">{{isChangeBar?_formatToStr(parseInt(curTime)):_formatToStr(parseInt(currentTime))}}</div>
        <div class="processInner" ref="processRef">
            <div class="processBar" @touchstart="ontouchstart" @touchmove="ontouchmove" @touchend="ontouchend"  :style="offsetDistanceStyle"></div>
            <div class="curProcess"></div>
        </div>
...
export default {
    ...
    methods: {
        ...
        ontouchmove(e) {
            ...
            this.$emit("onchangeBar",{changeBarStatus:true})
        },
        ontouchend(e) {
